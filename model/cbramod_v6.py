...
class PatchEmbedding(nn.Module):
    def __init__(self, in_dim, d_model, param):
        ...
        self.temporal_pos_encoding = nn.Parameter(torch.randn(1, 1, 10, d_model) * 0.02)
        self.time_norm            = nn.LayerNorm(100, elementwise_affine=False)
    ...
    def forward(self, x, mask=None):
        ...
        patch_emb    = patch_emb + self.temporal_pos_encoding[:, :, :P, :]
